...
/***/ "./components/01-elements/06-buttons/_buttons.js":
/*!*******************************************************!*\
  !*** ./components/01-elements/06-buttons/_buttons.js ***!
  \*******************************************************/
...
(function (Drupal, window) {
  ...
  Drupal.behaviors.materialDesignInitButton = {
    attach: function attach(context) {
      var buttons = document.querySelector('.js-mdc-button');
      var fabs = document.querySelector('.mdc-fab');

      if (buttons) {
        var ripple = new _ripple.MDCRipple(buttons);
      }
      if (fabs) {
        var fabRipple = new _ripple.MDCRipple(fabs);
      }
    }
  };
})(Drupal, undefined);
...
__webpack_require__(/*! ./components/01-elements/06-buttons/_buttons */ "./components/01-elements/06-buttons/_buttons.js");
